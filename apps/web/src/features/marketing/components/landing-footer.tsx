        ...
        <div className="grid grid-cols-1 gap-8 border-b border-border pb-12 md:grid-cols-4">
          ...
          <div className="space-y-4 md:col-span-2">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-muted-foreground">
              DealFlow360 is an intelligent, self-governing sales operations platform that automates
              the quotation-to-cash lifecycle for B2B enterprises.
            </p>
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-bold tracking-wider text-foreground uppercase">Platform</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <a href="#roles" className="transition-colors hover:text-primary">
                  Role Personas
                </a>
              </li>
            </ul>
          ...
          {/* Workspaces */}
          <div className="space-y-3">
            <h4 className="text-xs font-bold tracking-wider text-foreground uppercase">Workspaces</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <Link to={appRoutes.app} className="transition-colors hover:text-primary">
                  Sales Rep Dashboard
                </Link>
              </li>
              <li>
                <Link to={appRoutes.login} className="transition-colors hover:text-primary">
                  Manager Approvals
                </Link>
              </li>
              <li>
