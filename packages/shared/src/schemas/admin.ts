...
export const updateSettingSchema = updateSettingInputSchema;
...
export const CANONICAL_SETTINGS: CanonicalSettingDef[] = [
  {
    ...
    description:
      "Finance escalation is automatically required when any line exceeds its tier discount ceiling by more than this percentage.",
    defaultValue: 5,
    type: "number",
  },
  {
    ...
    description:
      "Escalates quote to Finance review when blended deal risk calculation exceeds this composite score.",
    defaultValue: 3,
    type: "number",
  },
  {
    ...
    description:
      "Quotes with total discounted value exceeding this threshold ($5,000.00 = 500000 cents) require Finance sign-off.",
    defaultValue: 500000,
    type: "number",
  },
  {
    ...
    description:
      "Quotations residing in active negotiation or review stages with no customer or rep activity past this threshold are flagged as stalled.",
    defaultValue: 7,
    type: "number",
  },
  {
    ...
    description:
      "Statistical z-score multiplier for anomaly detection: flags discounts exceeding k standard deviations above the rep baseline.",
    defaultValue: 2,
    type: "number",
  },
  {
    ...
    description:
      "Minimum historical deal volume required for a sales representative before autonomous discount anomaly detection activates.",
    defaultValue: 5,
    type: "number",
  },
  {
    ...
    description:
      "Global runtime kill-switch controlling autonomous agent evaluation and LLM recommendation assistants.",
    defaultValue: false,
    type: "boolean",
  },
];
...
export const INITIAL_AUDIT_LOGS: AuditLog[] = [
  ...
  },
  {
    ...
    reason:
      "Approved 16.5% discount due to verified multi-year commitment with Nordic Dynamics.",
    diff: {
      quotationId: "qt-102",
      status: "APPROVED",
      discountPct: 16.5,
