...
export const approverLevelSchema = approvalLevelSchema;
export type ApproverLevel = ApprovalLevel;
...
export const createQuotationInputSchema = createQuotationSchema;
...
export const addLineInputSchema = addLineSchema;
...
export const updateLineInputSchema = updateLineSchema;
...
export const decisionSchema = z.object({
  ...
  reason: z
    .string()
    .min(1, "Reason is required for all approval decisions.")
    .optional(),
});
export type DecisionInput = z.infer<typeof decisionSchema>;

export const approvalDecisionInputSchema = decisionSchema;
export type ApprovalDecisionInput = DecisionInput;

export const submitApprovalDecisionInputSchema = decisionSchema;
export type SubmitApprovalDecisionInput = DecisionInput;

export const bulkDiscountInputSchema = z.object({
  discountPct: z
    .number()
    .min(0, "Discount cannot be negative")
    .max(100, "Discount cannot exceed 100%"),
});
export type BulkDiscountInput = z.infer<typeof bulkDiscountInputSchema>;
...
const p01 = SEED_PRODUCTS[0] as Product;
const p02 = SEED_PRODUCTS[1] as Product;
const p03 = SEED_PRODUCTS[2] as Product;
const p04 = SEED_PRODUCTS[3] as Product;

const c01 = SEED_CUSTOMERS[0];
const c02 = SEED_CUSTOMERS[1];
const c03 = SEED_CUSTOMERS[2];
const c04 = SEED_CUSTOMERS[3];
...
export const SEED_QUOTATIONS: Quotation[] = [
  {
    ...
    subtotalMinor: 4800000,
    discountTotalMinor: 240000,
    taxTotalMinor: 364800,
  ...
  },
  {
    ...
    subtotalMinor: 3800000,
    discountTotalMinor: 684000,
    taxTotalMinor: 249280,
    grandTotalMinor: 3365280,
    marginPct: 24.8,
    ...
    lines: [
      {
        ...
        qty: 10,
        unitPriceMinor: 380000,
        unitCostMinor: 220000,
        discountPct: 18.0,
        lineType: "ONE_TIME",
  ...
  },
  {
    ...
    status: "APPROVED",
    blendedRiskScore: 0.0,
    subtotalMinor: 5880000,
    discountTotalMinor: 588000,
